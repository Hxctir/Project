...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
################################################### [4] Indexing, Slicing, Editing, Deleteing & Reversing ##############################################################
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
# [3] Replacing:
My_List[1]= 0
print(My_List) # [ 'Ahmed' , 0000 , 'Mohamed' , 200 , 1.5 , True ]

# [4] Deleting:
My_List[0:1]=[]
print(My_List) # [ 'Ali' , 'Mohamed' , 200 , 1.5 , True ]

# [5] Reversing:
print(My_List[::-1]) # [True, 1.5, 200, 'Mohamed', 'Ali', 'Ahmed']
...
print(f'My Name is: {My_Name}, and My Age is: {My_Age}, and My GPA is: {My_GPA:.5f}')

#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
############################################################ [9] Numbers & Arithmetic operators ########################################################################
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
# Can convert between integer & float, but can't convert from complex to others
...
List_1 = ['Mohamed','Osama','Ahmed']
List_2 = ['Kamel','Rawan','Salma']

#--------------------------------------------------------------------------
# [1] .append()

List_1.append('Alaa')
print(List_1) # ['Mohamed','Osama','Ahmed','Alaa']
#--------------------------------------------------------------------------
# [2] .extend()

List_1.append(List_2)
print(List_1) # ['Mohamed','Osama','Ahmed','Alaa',['Kamel','Rawan','Salma']]
...
List_1.remove('Alaa')
print(List_1) # ['Mohamed','Osama','Ahmed','Kamel','Rawan','Salma']
#--------------------------------------------------------------------------
# [4] .sort()

List_3 = [4,5,3,2,6,7,8,1]

List_3.sort()
print(List_3) # [1, 2, 3, 4, 5, 6, 7, 8]

List_3.sort(reverse=True)
print(List_3) # [8, 7, 6, 5, 4, 3, 2, 1]
#--------------------------------------------------------------------------
# [5] .reverse()
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
######################################################################## [12] Tuple & tuble methods ###################################################################
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------

Tuple_1 = 'Osama' , 'Ahmed' , 1 , 5 , 7.5 , True
print(type(Tuple_1)) # Tuble

Tuple_2 = 'Ahmed',
print(type(Tuple_2)) # Tuble

# Methods:
print(Tuple_1.count('Osama'))
...
My_Set = { 'Osama' , 'Ahmed' , 1 , 5 , 7.5 , True }
print(type(My_Set))
...
file = open(r'C:\Users\eleman\Mohamed.txt','r')

print(file)
print(file.name)
print(file.mode)
print(file.encoding)
print(file.read()) # Read file components
print(file.read(10))
print(file.readline()) # Read only one line
print(file.readline(10)) 
print(file.readlines()) # Read all lines in a form of lists
print(file.readlines(10))
print(type(file.readlines())) # Type= List
file.close() # Close file

# To break ata certain line:
for line in file:
    print(line)
...
file = open(r'C:\Users\eleman\Badran.txt','w') # Create a new file, erase the past entered data everytime used
file.write('Hello from Python\n')
file.write('Do you love Python?')
file.write('My name is Mohamed\n' * 10 )

List= ['Osama\n','Mohamed\n','Islam\n']
file = open(r'C:\Users\eleman\Badran.txt','w')
...
file = open(r'C:\Users\eleman\Mohamed.txt', 'a') # add to the current file
file.write("This is a new line.\n")
file.truncate(20)
print(file.tell()) # Tell position of cursor
file.seek(10) # Put cursor on selected spot
...
variable_1 = 'Hello ' # string variable
variable_2 = 'Python!'
variable_3 = variable_1 + variable_2 # arithmetic operators
print(variable_3)

#-------------------------------------------------------------

# [4] Conditional ( if / elif / else )
# جعل البرنامج يتخذ قؤاؤات مختلفة بناء على شروط محددة

if type(variable_1) == str:
    print(variable_3)

elif type(variable_2) != str:
    print('Not string')
...
# [5] Loops ( for / while )
# نكرر الكود عدد معين من المرات حسب شرط معين

for variable in variable_3:
    print(variable)
...
# [6] Functions ( def )
# جزء من الكود بنكتبه مرة واحدة ونقدر نستخدمه أكتر من مرة

def myfunction():
    variable1 = 'My name is '
    variable2 = input('Enter your name: ')
